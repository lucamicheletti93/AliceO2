...
class TrackLTF : public TrackMFTExt
{
 public:
  ...
  void setPoint(const Cluster& cl, const Int_t layer, const Int_t clusterId, const MCCompLabel label, const Int_t extClsIndex, const Int_t pippoClsSize);
...
//_________________________________________________________________________________________________
inline void TrackLTF::setPoint(const Cluster& cl, const Int_t layer, const Int_t clusterId, const MCCompLabel label, const Int_t extClsIndex, const Int_t pippoClsSize)
{
  ...
  setPippoClusterSize(nPoints, pippoClsSize);
  setClusterLayer(nPoints, layer);
